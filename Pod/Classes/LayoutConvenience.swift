...
public var defaultInsetConstraint: InsetConstraint {
    return (constant: 0.0, priority: UILayoutPriority.required)
}
...
public struct InsetConstraints {
    ...
    public init(insets: UIEdgeInsets, horizontalPriority: UILayoutPriority = UILayoutPriority.required, verticalPriority: UILayoutPriority = UILayoutPriority.required) {
    ...
    public init(insets: UIEdgeInsets, priority: UILayoutPriority = UILayoutPriority.required) {
